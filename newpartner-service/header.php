...
<script src="/bitrix/templates/<?=SITE_TEMPLATE_ID;?>/js/jquery-ui.js"></script>
...
if (isset($_GET['modalWin']))
{
	...
	$type_v['type1'][0] = "'http://newpartner.ru/forms/form2.php'";
...
?>
<script src="/bitrix/templates/newpartner/js/scripts.js"></script>
</head>
...
<form action="" method="get">
<label for="">Номер телефона:</label> <input type="text" name="" value="" id="number_phone" class="maskphone"/>
...
<form action="" method="get">
<label for="">Вызвать курьера на дату:</label> <input type="text" name="" value="" id="number_date" class="date_format"/>
