...
?>
<h2 class="partner">Список обращений</h2>
<div class="row">
	<div class="col-md-12">
        <form method="post" action="<?=$arResult["NEW_TICKET_PAGE"]?>" id="add_new_ticket" class="form-inline" style="display:inline-block;">
            <input type="submit" name="add" value="<?=GetMessage("SUP_ASK")?>" class="btn btn-warning">
        </form>
    </div>
</div>
